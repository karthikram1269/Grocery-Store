...
<body>
	...
	<form action="editItem">
		...
		<input type="number" id="itemid"
			value="<%=db.getItemid()%>" readonly="readonly" name="itemid">

		<label for="itemtype">Item Type:</label> 
		<input type="text"
			id="itemtype" name="itemtype" value="<%=db.getItemtype()%>"
			readonly="readonly"> 
			
		<label for="itemname">Item Name:</label> <input
			type="text" id="itemname" name="itemname" value="<%=db.getItemname()%>">

		<label for="price">Item Price:</label> 
		<input type="number" id="price"
			name="price" value="<%=db.getItemprice()%>"> 
			
		<label
			for="quantity">Item Quantity:</label> <input type="text"
			id="quantity" name="quantity" value="<%=db.getItemquantity()%>">

		<label for="image">Item Image:</label> 
		<input type="text" id="image"
			placeholder="Enter image URL" name="image" value="<%=db.getItemimage()%>"> 
			
			<label for="email">Email:</label>
		<input type="text" id="email" name="email"
			value="<%=db.getEmail()%>" readonly="readonly"> <input
	...
	%>
	<h1>item not found to update !!</h1>
	<%
	}
	%>
