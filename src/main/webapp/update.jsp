...
<body>
	...
	<form action="edit" method="post">
		...
		<label for="usertype">User Type:</label> <input type="text"
			id="usertype" value="<%=db.getUsertype()%>" readonly="readonly">

		<label for="name">Name:</label> <input type="text" id="name"
			name="name" value="<%=db.getName()%>"> <label for="email">Email:</label>
		<input type="email" id="email" name="email"
			value="<%=db.getEmail()%>" readonly="readonly"> <label
			for="psw">Password:</label> <input type="password" id="psw"
			name="psw" value="<%=db.getPassword()%>" readonly="readonly">

		<label for="phone">Phone:</label> <input type="tel" id="phone"
			placeholder="Enter your phone" name="phone"
			value="<%=db.getPhone()%>"> <label for="address">Address:</label>
		<input type="text" id="address" placeholder="Enter your address"
			name="address" value="<%=db.getAddress()%>"> <input
